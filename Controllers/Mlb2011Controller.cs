...
{
    public class Mlb2011Controller : Controller
    {
        private readonly IMlb2011Repository _mlb2011Repository;
        public Mlb2011Controller(IMlb2011Repository mlb2011Repository)
        {
            _mlb2011Repository = mlb2011Repository;
        }
        ...
        public async Task<IActionResult> Index(string searchString, string searchValue, string searchColumn, string sortOrder, int pageNumber, string currentFilter, string pageSize, string selectedMonth)
        {
            ...
            var mlbs2011 = _mlb2011Repository.GetAllAsync();


            //Filtering
            if (!string.IsNullOrEmpty(searchColumn) && !string.IsNullOrEmpty(searchValue))
            {
                var propertyInfo = typeof(Mlb2011ViewModel).GetProperty(searchColumn);
                ...
                {
                    var param = Expression.Parameter(typeof(Mlb2011ViewModel), "e");
                    ...
                    if (propertyInfo.PropertyType == typeof(string))
                    {
                        ...
                        var lambda = Expression.Lambda<Func<Mlb2011ViewModel, bool>>(
                            Expression.AndAlso(
                        ...
                        mlbs2011 = mlbs2011.Where(lambda);
                    }
                    else if (propertyInfo.PropertyType == typeof(int))
                    {
                        if (int.TryParse(searchValue, out int searchIntValue))
                        {
                            ...
                            var lambda = Expression.Lambda<Func<Mlb2011ViewModel, bool>>(equalExpression, param);
                            mlbs2011 = mlbs2011.Where(lambda);
                        }
                        else
                        {
            ...
            if (!string.IsNullOrEmpty(selectedMonth))
            {
                ...
                mlbs2011 = mlbs2011.Where(e => e.Date >= monthStart && e.Date <= monthEnd);
            ...
            {
                case "id_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Id);
                    break;
                case "id_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Id);
                    break;
                case "date_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Date);
                    break;
                case "date_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Date);
                    break;
                case "rot_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Rot);
                    break;
                case "rot_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Rot);
                    break;
                case "vh_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.VH);
                    break;
                case "vh_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.VH);
                    break;
                case "team_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Team);
                    break;
                case "team_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Team);
                    break;
                case "pitcher_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Pitcher);
                    break;
                case "pitcher_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Pitcher);
                    break;
                case "1st_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._1st);
                    break;
                case "1st_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._1st);
                    break;
                case "2nd_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._2nd);
                    break;
                case "2nd_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._2nd);
                    break;
                case "3rt_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._3rd);
                    break;
                case "3rt_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._3rd);
                    break;
                case "4th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._4th);
                    break;
                case "4th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._4th);
                    break;
                case "5th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._5th);
                    break;
                case "5th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._5th);
                    break;
                case "6th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._6th);
                    break;
                case "6th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._6th);
                    break;
                case "7th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._7th);
                    break;
                case "7th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._7th);
                    break;
                case "8th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._8th);
                    break;
                case "8th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._8th);
                    break;
                case "9th_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e._9th);
                    break;
                case "9th_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e._9th);
                    break;
                case "final_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Final);
                    break;
                case "final_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Final);
                    break;
                case "open_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Open);
                    break;
                case "open_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Open);
                    break;
                case "close_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.Close);
                    break;
                case "close_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.Close);
                    break;
                case "openou_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.OpenOU);
                    break;
                case "openou_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.OpenOU);
                    break;
                case "closeou_asc":
                    mlbs2011 = mlbs2011.OrderBy(e => e.CloseOU);
                    break;
                case "closeou_desc":
                    mlbs2011 = mlbs2011.OrderByDescending(e => e.CloseOU);
                    break;
                default:
                    mlbs2011 = mlbs2011.OrderBy(e => e.Id); // Default sorting by ID
                    break;
            }
            ...
            if (pageSize == "All")
            {
                selectedPageSize = mlbs2011.Count();
            }
            else
            {
            ...
            return View(await PaginatedList<Mlb2011ViewModel>.CreateAsync(mlbs2011.AsQueryable(), pageNumber, selectedPageSize));
        }

        [HttpGet]
        public IActionResult Add()
        {
            return View(new Mlb2011ViewModel());
        }

        public async Task<IActionResult> Add(Mlb2011ViewModel model)
        {
            if (!ModelState.IsValid)
            {
                return View(model);
            }
            await _mlb2011Repository.AddAsync(model);
        ...
        public async Task<IActionResult> Delete(int id)
        {
            ...
            await _mlb2011Repository.DeleteAsync(id);
            // Redirect to List all department page
            return RedirectToAction();
        }

        [HttpPost]
        public async Task<IActionResult> Edit(Mlb2011ViewModel mlb2011)
        {

            if (!ModelState.IsValid)
            {
                return View(mlb2011); // Return to the form with validation errors
            }
            //Update the database with modified details
            await _mlb2011Repository.UpdateAsync(mlb2011);
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var mlb2011 = await _mlb2011Repository.GetByIdAsync(id);
            return View(mlb2011);
        }
        ...
        public async Task<IActionResult> GroupByColumn(string groupColumn)
        {
            ...
            var allRecords = await _mlb2011Repository.GetAllAsListAsync(); // ใช้เมธอดใหม่

            // ตรวจสอบให้แน่ใจว่า groupColumn เป็นชื่อคอลัมน์ที่ถูกต้อง
            if (string.IsNullOrEmpty(groupColumn) ||
                !typeof(Mlb2011ViewModel).GetProperties().Any(p => p.Name.Equals(groupColumn, StringComparison.OrdinalIgnoreCase)))
            {
